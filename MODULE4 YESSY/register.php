...
<div class="card shadow-lg" style="width: 30rem;height: 40rem;;margin-left:30%; margin-top:5%">
  ...
  <div class="form-group" style="margin-left:40px">
    ...
    <div class="col-lg-9">
    <input type="number" class="form-control" name="no_hp" placeholder="Masukkan Nomor Handphone">
    </div>
  </div>
  <div class="form-group" style="margin-left:40px">
  ...
  <div class="form-group" style="margin-left:40px">
    ...
    <div class="col-lg-9">
    <input type="password" class="form-control" name="password2" placeholder="Konfirmasi Kata Sandi">
    </div>
  </div>
